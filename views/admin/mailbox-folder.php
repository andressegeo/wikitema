...
<html class="fixed sidebar-left-collapsed">
	...
	<!-- 	<script src="http://ajax.googleapis.com/ajax/libs/jquery/1.5.1/jquery.min.js" type="text/javascript">
		...
		$(document).ready(function() { 
			...
			$(".item-action fa fa-times text-danger").click(function(){ 
				...
				$.ajax({ 
							type: "GET", 
							url: "supmesgAjax.php?type_demande="+req, 
							data : "html", 
		...
		<title>Inbox | Porto Admin - Responsive HTML5 Template 1.4.2</title>
		...
		<section class="body">
			...
			<header class="header">
				<div class="logo-container">
					<a href="../" class="logo">
						<img src="../../assets/images/lodgo.png" height="55" alt="Porto Admin" />
					</a>
