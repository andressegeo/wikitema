			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					<header class="page-header">
						<h2 style='align:center'>WikHitema Administration</h2>
					...
					<!-- end: page -->
						<div class="row">		
							<div class="col-md-6">
								<form action="../../controller/valid.php" method="post" id="form2" class="form-horizontal form-bordered">
									<section class="panel">
										<header class="panel-heading">
											...
											<h2 class="panel-title">CREER UNE THEMATIQUE</h2>
										</header>
										<div class="panel-body">
											<div class="form-group">
							...
							<form action="../../controller/valid.php" method="post" id="form2" class="form-horizontal form-bordered">
								<section class="panel">
									...
									<div class="panel-body">
										...
										<div class="form-group">
											<label class="col-sm-3 control-label">Thème<span class="required">*</span></label>
											<div class="col-sm-9">
												<?php 
												$obj=new User();
												echo '<select id="level" name="level" class="form-control" required>';
												for ($i=0; $i <10 ; $i++) { 
													$data = $obj->retrieve_theme()[$i]['label'];
										...
										<div class="form-group">
											<label class="col-sm-3 control-label">Titre <span class="required">*</span></label>
											<div class="col-sm-9">
												<input type="text" name="titre" class="form-control" placeholder=" Certifications" required/>
											</div>
										</div>
										
										<div class="form-group">
											<label class="col-sm-3 control-label">Commentaire <span class="required">*</span></label>
											<div class="col-sm-9">
												<textarea name="com" rows="5" title="Your resume is too short." class="form-control" placeholder="Commentez votre article" required></textarea>
											</div>
										</div>
							...
							<form action="../../controller/valid.php" method="post" id="form2" class="form-horizontal form-bordered">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">AJOUTER UN USER</h2>
										<p class="panel-subtitle">
									...
									<div class="panel-body">
										...
										<div class="form-group">
											<label class="col-sm-3 control-label">Identifiant <span class="required">*</span></label>
											<div class="col-sm-9">
												<input type="number" name="iden" class="form-control" placeholder="eg.: 2017005" required/>
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
												<input type="text" name="nom" class="form-control" placeholder=" Andresse Geo" required/>
											</div>
										</div>
										<div class="form-group">
											<label class="col-sm-3 control-label">Login <span class="required">*</span></label>
											<div class="col-sm-9">
												<input type="text" name="login" class="form-control" placeholder=" andressegeo" required/>
											</div>
										</div>
										<div class="form-group">
											<label class="col-sm-3 control-label">Mot de passe <span class="required">*</span></label>
											<div class="col-sm-9">
								...
								<form action="../../controller/valid.php" method="post" id="form2" class="form-horizontal form-bordered">
									<section class="panel">
										<header class="panel-heading">
											...
											<h2 class="panel-title">AJOUTER CONTENU MULTIMEDIA</h2>
										</header>
										<div class="panel-body">
											<div class="form-group">
